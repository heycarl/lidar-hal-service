...
The following diagram illustrates how a single rotation of the LiDAR is processed and delivered to multiple clients simultaneously:
...
git clone [https://github.com/heycarl/lidar-hal-service.git](https://github.com/heycarl/lidar-hal-service.git)
...
Data is delivered in JSON format. Every message is wrapped in an "envelope" with a `type` field, allowing clients (e.g., TouchDesigner or JavaScript) to route different message types efficiently.
